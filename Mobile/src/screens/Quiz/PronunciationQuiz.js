...
export default function PronunciationQuiz({route, navigation}) {
    ...
    const getAnswers = (index)=>{
        uri = 'https://englephant.vercel.app/api/pronunciation/answer/'+quizzes[index]._id;
        axios.get(uri)
        .then(function (res) {
    ...
    const unlockExercise = (lessonId) => {
        uri = 'https://englephant.vercel.app/api/pronunciation/'+lessonId;
        axios.post(uri,{
            learnerId: learnerId
        })
        .then(function (res) {
    ...
    const sendResult = () => {
        uri = 'https://englephant.vercel.app/api/pronunciation/result/'+lessonId;
        axios.put(uri,{
            learnerId: learnerId,
            sound1: sound1,
